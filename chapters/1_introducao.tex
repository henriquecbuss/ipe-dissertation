...
da programação funcional, como Java, JavaScript, C\#, e Python.
...
objetivo é explorar as ideias funcionais no desenvolvimento \textit{backend}. Por
conta disso, a linguagem \textit{Ipe} não deve ser usada no mundo real, em projetos
reais.
