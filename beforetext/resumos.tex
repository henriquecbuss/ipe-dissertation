...
\newcommand{\imprimirbrazilabstract}{%
    ...
    \begin{otherlanguage*}{brazil}
        \begin{resumo}[Resumo]
            ...
            seguindo o estilo funcional. Com as garantias do paradigma funcional
            e da tipagem estática, Ipe busca ser uma linguagem simples e fácil de
            se usar, ao mesmo tempo em que tenta capturar todos os erros em tempo
            de compilação, evitando erros em tempo de execução.
