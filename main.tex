...
\titulo{\lang{The Ipe programming language}{Linguagem de programação Ipe}}
\subtitulo{\lang{Purely functional programming for REST APIs}{Programação puramente funcional para APIs REST}}

\orientador[\lang{Supervisor}{Orientador(a)}]{\brazilword{Prof. Maicon Rafael Zatelli}, \lang{Phd.}{Dr.}}

\coordenador[\lang{Coordinator}{Coordenador(a)}]{\brazilword{Prof. Lucia Helena Martins Pacheco}, \lang{Phd.}{Dr.}}
...
\data{\lang{11 de julho}{11 de julho de} 2023}
...
\include{chapters/7_resultados_obtidos}

\include{chapters/8_consideracoes_finais}
...
\begin{apendicesenv}
    ...
    \include{aftertext/apendice_github}
\end{apendicesenv}
